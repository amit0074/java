...
public class ComparatorDemo {
    ...
    public static void main(String[] args) {
        ...
        ComparatorDemo obj1 = new ComparatorDemo(1, "Amit", "Satara");
        ComparatorDemo obj2 = new ComparatorDemo(1, "Tejas", "Nashik");
        ComparatorDemo obj3 = new ComparatorDemo(1, "Manish", "Dubai");
